...
DB_CONTAINER_NAME="myopenait3-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=myopenait3 -d -p 5432:5432 docker.io/postgres
